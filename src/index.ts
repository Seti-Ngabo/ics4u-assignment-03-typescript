...
console.log(
  ' → Inner circle radius: ' + triangle1.innerCircleRadius().toFixed(4) + ' mm'
)
console.log(
  ' → Circumcircle radius: ' + triangle1.circumsicleRadius().toFixed(4) + ' mm'
)
console.log('')
...
console.log(
  ' → Inner circle radius: ' + triangle2.innerCircleRadius().toFixed(4) + ' mm'
)
console.log(
  ' → Circumcircle radius: ' + triangle2.circumsicleRadius().toFixed(4) + ' mm'
)
console.log('')
...
console.log(
  ' → Inner circle radius: ' + triangle3.innerCircleRadius().toFixed(4) + ' mm'
)
console.log(
  ' → Circumcircle radius: ' + triangle3.circumsicleRadius().toFixed(4) + ' mm'
)
console.log('')
...
console.log(
  ' → Inner circle radius: ' + triangle4.innerCircleRadius().toFixed(4) + ' mm'
)
console.log(
  ' → Circumcircle radius: ' + triangle4.circumsicleRadius().toFixed(4) + ' mm'
)
console.log('')
...
console.log(
  ' → Inner circle radius: ' + triangle5.innerCircleRadius().toFixed(4) + ' mm'
)
console.log(
  ' → Circumcircle radius: ' + triangle5.circumsicleRadius().toFixed(4) + ' mm'
)
